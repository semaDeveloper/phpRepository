<nav class="navbar navbar-expand-lg navbar-light" style="background-color:#F44336">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="makarna.php"><b>Makarnalarımız</b></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="tarifler.php"><b>Tarifler</b></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="iletisim.php"><b>İletişim</b></a>
            </li>


            <?php if(isset($_COOKIE["oturum"])){ ?>
            <li class="nav-item">
                <a class="nav-link" href="admin/index.php"><b>Mesajlar</b></a>
            </li>
            <?php } ?>
        ...
        <form class="form-inline my-2 my-lg-0">
            <a class="btn btn-warning" href="cikis.php" role="button"><i class="fas fa-sign-out-alt"></i> Çıkış
                Yap</a>
        </form>
        <?php }else{ ?>
        <form class="form-inline my-2 my-lg-0">
